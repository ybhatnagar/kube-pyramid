...
|---|---|---|
| `--db-driver` | `KUBEPYRAMID_DB_DRIVER` | `sqlite` (or `postgres`) |
| `--db-dsn` | `KUBEPYRAMID_DB_DSN` | `./kubepyramid.db` |
| `--prom-url` | `KUBEPYRAMID_PROM_URL` | `http://prometheus.monitoring:9090` |
| `--prom-bearer` | `KUBEPYRAMID_PROM_BEARER` | — |
